...
public class SequenceToSignatures {
  ...
  private static void usage() {
    System.err.println("Usage: java edu.jhu.thrax.tools.SequenceToSignatures");
    System.err.println("\t -i sequence_file \t Sequence file from Thrax signature extraction.");
    System.err.println("\t -o prefix \t\t Prefix for signature files: <prefix>.<group>.0001.keys.gz.");
